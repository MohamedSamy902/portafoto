<header>
    ...
    <div class="header-main">
        <div class="container">
            ...
            <div class="header-user-actions">
                <a href="<?php echo e(route('trackOrder')); ?>"><button class="action-btn truck" type="button">
                        <img
    ...
    <div class="mobile-bottom-navigation">
        ...
        <a style="color: var(--eerie-black);" href="<?php echo e(route('trackOrder')); ?>" class="action-btn"
