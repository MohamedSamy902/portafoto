                                    ...
                                    <table class="table table-bordered table-striped">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="Hours">
                                                    <h6 class="p-2 mb-0"><?php echo e(__('site.image')); ?></h6>
                                                </td>
                                                <td class="Hours">
                                            ...
                                            <?php $__currentLoopData = $invoice->cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><img style="max-width: 100px;max-height: 100px;"
                                                            src="<?php echo e($cart->product->getFirstMediaUrl('products') != null ? $cart->product->getFirstMediaUrl('products') : asset('assets/images/dashboard/1.png')); ?>">
                                                    </td>
