                                ...
                                <tbody>
                                    @foreach ($customers as $customer)
                                        <tr>
                                            ...
                                            {{-- <td>{{ $customer->roles_name }}</td> --}}

                                            <td><img style="max-width: 100px;max-height: 100px;" src="{{ $customer->getFirstMediaUrl('customer') != null ?  $customer->getFirstMediaUrl('customer') : asset('assets/images/dashboard/1.png')}}"></td>
                                            <td>
                                                <div style="display: flex;">
                                                    @can('customer-edit')
                                                        <a class="btn btn-outline-primary-2x" style="margin:0 20px;"
                                                            href="{{ route('customers.edit', $customer->id) }}">{{ __('master.edit') }}</a>
                                                    @endcan
