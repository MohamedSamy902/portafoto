...
@section('content')
    @component('components.breadcrumb')
        @slot('breadcrumb_title')
            <h3>{{ __('city.city') }}</h3>
        @endslot
        <li class="breadcrumb-item active">{{ __('city.city') }}</li>
    @endcomponent
                                ...
                                <tbody>
                                    @foreach ($cities as $city)
                                        <tr>
                                            ...
                                            <td style="{{  $city->status == 'inactive' ? 'background-color: #e17575;' : ''}}>{{ $city->status}}</td>

                                            <td>
                                                <div style="display: flex;">
                                                    @can('city-chengStatus')
                                                        <a class="btn btn-outline-primary-2x" style="margin:0 20px;"
                                                            href="{{ route('city.chengStatus', $city->slug) }}">{{ __('master.chengStatus') }}</a>
                                                    @endcan
