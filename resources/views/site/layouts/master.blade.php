        ...
        <div class="container pt-3 text-sm-center text-lg-left">
            ...
            <div class="row position-relative">
                ...
                <div class="col-sm-12 col-lg-4">
                    ...
                    <p class="text-white-50 author justify-content-sm-center justify-content-lg-start pt-3">
                        {{ __('site.Created By') }}
                ...
                <div class="col-sm-12 col-lg-4">
                    ...
                    <div class="rounded-social-buttons">
                        ...
                        <a class="social-button instagram" href="{{ $setting->instagram }}" target="_blank"><img
                                alt="svgImg"
