            ...
            <div class="row">
                <div class="payment col-md-6 col-lg-8">
                    ...
                    <form method="POST" action="{{ route('customers.payment.store') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputFirst"
                                    placeholder="{{ __('site.firstName') }}" name="firstName"
                                    value="{{ old('firstName') }}" />
                            </div>
                            <div class="form-group col-md-6">
                                {{-- <label for="inputLast">{{ __('site.lastName') }}</label> --}}
                                <input type="text" class="form-control" id="inputLast"
                                    placeholder="{{ __('site.lastName') }}" name="lastName" value="{{ old('lastName') }}" />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputAddress"
                                    placeholder="{{ __('site.address_1') }}" name="address_1"
                                    value="{{ old('address_1') }}" />
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control" id="inputZip"
                                    placeholder="{{ __('site.zip') }}" name="zip_code" value="{{ old('zip_code') }}" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row flex-direction-column">

                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1"
                                    value="option1" checked onclick="checkMe(this.checked);">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2"
                                    value="option2" onclick="checkMe(this.checked);">
                            ...
                            <div class="form-check col-md-12">
                                ...
                                {{-- <input class="form-check-input" type="radio" onclick="checkMe(this.checked);" />Show
                                Form --}}
                                <div id="divcheck" style="display:none;">
                                    <div class="check-body">
                                        <h4>Product</h4>
                                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt, veniam. Ipsam
                                            magni voluptas dolore illo debitis cumque ab dolores eligendi at praesentium
                                            totam incidunt accusamus perferendis, nostrum accusantium similique saepe.
                                        </p>
                                    </div>
                                </div>
                            </div>
